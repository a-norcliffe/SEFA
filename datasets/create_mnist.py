...
if __name__ == "__main__":
  ...
  X_train_val = torch.stack([batch[0].view(-1) for batch in mnist_train_val], dim=0).float()
  y_train_val = torch.tensor([batch[1] for batch in mnist_train_val]).long()
  ...
  best_features = np.array([153, 154, 210, 211, 243, 269, 271, 295, 327, 348,
                            350, 375, 405, 409, 427, 430, 461, 514, 543, 655])
